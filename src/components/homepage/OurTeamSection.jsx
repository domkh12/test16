...
function OurTeamSection() {
  ...
  const teamMembers = [
    ...
    { title: "SEM SOPAHNA", desc: "When I wake up, First thing to do for me is play game.", role: "Front-End/UX/UI", github: "https://github.com/SopanhaSem", facebook: "https://www.facebook.com/profile.php?id=100035612538137", img: "teamimg/panha.jpg" },
    { title: "KHUON CHHOEURN", desc: "The best person in the world is me.", role: "Front-End/UX/UI", github: "https://github.com/ChhoeunKhuon", facebook: "https://www.facebook.com/mnus.tmey.94064?mibextid=ZbWKwL", img: "teamimg/chhoeurn2.png" },
    { title: "MOM RAKSMEY", desc: "I can't live without love, Because love is life.", role: "Front-End/UX/UI", github: "https://github.com/raksmeymom", facebook: "https://www.facebook.com/profile.php?id=100069487637655&mibextid=ZbWKwL", img: "teamimg/raksmey.jpg" },
    { title: "RETH SARAKNORIN", desc: "I'm alway dreaming about you, Why you are so cute.", role: "Front-End/UX/UI", github: "https://github.com/itsmestevee", facebook: "https://www.facebook.com/bobaaa13?mibextid=LQQJ4d", img: "teamimg/norin.png" },
    { title: "SOY SREYTEY", desc: "Hey, Can i borrow 10$ please.", role: "Front-End/UX/UI", github: "https://github.com/Zeiitey", facebook: "https://www.facebook.com/profile.php?id=100057300903859&mibextid=LQQJ4d", img: "teamimg/tey.png" },
    { title: "HOR RATHA", desc: "I never give up to achieve my dream.", role: "Front-End/UX/UI", github: "https://github.com/HorRatha", facebook: "https://www.facebook.com/thouy.dp.7?mibextid=LQQJ4d", img: "teamimg/rotha.png" },
    { title: "SRIV NARY", desc: "Be my boyfriend, If you want to learn IT.", role: "Front-End/UX/UI", github: "https://github.com/SrivNary", facebook: "https://www.facebook.com/profile.php?id=100046388491383&mibextid=ZbWKwL", img: "teamimg/navy.png" },
    { title: "NGOV BUNSINH", desc: "I love sleeping, Sleeping is my life. ", role: "Front-End/UX/UI", github: "https://github.com/Bunsinhh", facebook: "https://www.facebook.com/NAMWOOON", img: "teamimg/bunxing.png" },
  ];
  ...
  <div className="flex flex-col w-full max-w-6xl justify-center gap-5 px-4 md:px-8">
    <div className="w-full text-center flex flex-col mt-8 xl:mt-14 max-w-[600px] mx-auto">
      ...
      <p className="text-base md:text-lg dark:text-gray-100 w-full text-center">
        At Show Case, we blend creativity with technology to craft unique, visually stunning, and effective digital solutions. With a passion for [your field, e.g., web design, development, digital marketing], we bring your vision to life through innovative design and meticulous attention to detail.
      </p>
    </div>
